...
def run():
    ...
    options = PipelineOptions(
        ...
        region="us-central1",
        temp_location="gs://gcs-bucket-pipeline-ct/temp",
        staging_location="ggs://gcs-bucket-pipeline-ct/staging"
    )
    ...
    with beam.Pipeline(options=options) as p:
        (
            ...
            | "Guardar resultados" >> beam.io.WriteToText("gs://gcs-bucket-pipeline-ct/output/wordcount")
        )
